...
chr=$1
bfile=/home/oleksanf/github/precimed/pleiofdr/ref/bfile/chr$chr
bim=$bfile.bim
...
mv baseline.$chr.annot.gz /home/oleksanf/github/precimed/pleiofdr/ref/bfile/baseline_v2.2.chr${chr}.annot.gz
...
# submission command:
# source activate bx
#for chr in $(seq 22); do echo "./baseline_v2.2_pleioFDR_ref.sh ${chr}"; done
